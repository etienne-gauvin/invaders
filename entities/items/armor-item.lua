...
-- Classe Item
local ArmorItem = Item:subclass('ArmorItem')

-- Images
local itemImage = love.graphics.newImage('assets/images/armor-item.png')

-- Constructeur
function ArmorItem:initialize(x, y)
  ...
  self.light.color1 = {0, 0, 1, 0.8}
  self.light.color2 = {0, 0, 1, 0.8}
...
function ArmorItem:beginContact(entity, contact, velocity)
